...
# 11 "newmain.c" 2
# 1 "../../../../opt/microchip/xc8/v2.45/pic/include/c90/math.h" 1



# 1 "../../../../opt/microchip/xc8/v2.45/pic/include/c90/__unsupported.h" 1
# 5 "../../../../opt/microchip/xc8/v2.45/pic/include/c90/math.h" 2
# 30 "../../../../opt/microchip/xc8/v2.45/pic/include/c90/math.h"
...
double tijd_opname = 0;
int index_counter = 0;

long double tijd_aan[20 + 1];
long double tijd_uit[20 + 1];
double preload_calc_on[20 + 1];
double preload_calc_off[20 + 1];
# 91 "newmain.c"
void pic_init(void);
void init_gpio(void);
void init_osc(void);
...
void timer_calc(void)
    ...
    for (int round = 0; round <= 20; round++)
        {
        if(round == 0)
            tijd_aan[round] = tijd_opname;
        else
            tijd_aan[round] = tijd_opname / (pow(round,2));
        tijd_uit[round] = 0.3 * tijd_aan[round];
        }
    for (int round = 0; round <= 20; round++)
        {
        preload_calc_on[round] = (-1 * (((125000 / 4) / 8) * tijd_aan[round] - 65536));
        preload_calc_off[round] = (-1 * (((125000 / 4) / 8) * tijd_uit[round] - 65536));
        }
    LATCbits.LATC3 = 0;
    }
...
void __attribute__((picinterrupt(("")))) isr(void)
    {
    if (TMR2IF && button_1_getriggerd == 1)
        {
        TMR2IF = 0;
        LATCbits.LATC1 ^= 1;
        }
    ...
    if (TMR1IF && button_1_getriggerd == 1 && release == 0)
        ...
        tijd_opname = (timer_opname_100ms);
        TMR1 = 61629;
        }
